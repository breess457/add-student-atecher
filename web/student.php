...
<script type="text/javascript">
 ...
 <?php
    if(!isset($_SESSION['remamber'])){
        ...
        $setSQL = "SELECT * FROM student_history AS S LEFT JOIN remamber AS R ON S.id_teacher = R.member_id";
        ...
        ";
          ...
          echo "</div> <hr />"; 
            ...
            echo"<h3 class=\"mb-3 mt-2 text-set\">จำนวนข้อมูลนักศึกษาทั้งหมด <span class=\"text-ggren\">$setnumber</span> คน</h3>";
